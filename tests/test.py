...
from app.apps.webpay.client import WebpayClient
...
class TestWebpayClient(unittest.TestCase):
    ...
    def test_generate_payment(self, mock_post: mock.MagicMock):
        ...
        payment_data = self.client.generate_payment({"total": Decimal('12.34'),
                                                     "invoice_item_price": [Decimal('12.34'),],
                                                     "order_num": "123", "currency_id": "BYN"})
        ...
        sign_key = f"{data['wsb_seed']}1231231BYN12.34secret"
    ...
    def test_check_webhook_sign(self):
        ...
        sign_key = f"2022-03-21T11:22:33ZBYN99.99card123test1234561789411111******1111secret"
